...
implicit none
   ...
   read (unit=arg,fmt=*) block_size
   call get_command_argument(3,arg)
   read (unit=arg,fmt=*) eps
   call get_command_argument(4,name_of_file)
   ...
   do
     ...
     do nx = 1, NB
      dm(nx) = 0
      !$OMP parallel do shared(array,nx,dm) private(i,j,m,l,s,t,temp,d)
     	do i = 1, nx
        j = nx + 1 - i
